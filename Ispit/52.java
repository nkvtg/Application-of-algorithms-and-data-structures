...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            transformations.putIfAbsent(source,destination);
        ...
        int price = 0;
        for(String vertex : transformations.keySet()) {
            Map<String,Integer> distances = graph.shortestPath(vertex);

            price += distances.get(transformations.get(vertex));
        }
