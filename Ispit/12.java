...
//        System.out.println(dll);
        ...
        while(curr != null){
            ...
            DLLNode<Integer> left = curr.pred;
            DLLNode<Integer> right = curr.succ;

            while(left != null){
                avgLeft+=left.element;
                countLeft++;
                left = left.pred;
            }
            avgLeft /= (double)countLeft;

            while(right != null){
                avgRight+=right.element;
                countRight++;
                right = right.succ;
            }
            avgRight /= (double)countRight;
